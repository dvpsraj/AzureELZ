...
Log_Subscription_name = "sub-mohg-log-01"
...
Prod_Subscription_name = "sub-mohg-prod-01"
...
NSP_Subscription_name  = "sub-mohg-nsp-01"
#===============================================================##===============================================================#
...
Prod_Vnet_cidr    = ["10.190.136.0/21"]
Prod_Subnet1_cidr = ["10.190.136.0/24"]
Prod_Subnet2_cidr = ["10.190.137.0/24"]
Prod_Subnet3_cidr = ["10.190.138.0/24"]
Prod_Subnet4_cidr = ["10.190.139.0/24"]
Prod_Subnet5_cidr = ["10.190.140.0/24"]
Prod_Subnet6_cidr = ["10.190.141.0/24"]
#===============================================================##===============================================================#
#===============================================================##===============================================================#
